  ...
  countdown = (function (v) {
    ...
    var E = (d.setFormat = function (a) {
      ...
      C = (d.resetFormat = function () {
        p = " millisecond; Giây; Phút; Giờ; Ngày; Tuần; Tháng; Năm; decade; century; millennium".split(
          ";"
        );
        q = " milliseconds; Giây; Phút; Giờ; Ngày; Tuần; Tháng; Năm; decades; centuries; millennia".split(
          ";"
        );
        r = ", ";
        t = ", ";
...
// let abc =countdown( new Date("May 30, 2020 00:00:00"),new Date(),countdown.YEARS|countdown.MONTHS|countdown.WEEKS|countdown.DAYS|countdown.HOURS|countdown.MINUTES|countdown.SECONDS ).toString();
// console.log(abc);
